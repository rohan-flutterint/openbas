...
public class AtomicTestingUtils {
  ...
  public static List<ExpectationResultsByType> getRawExpectationResultByTypes(
    ...
    List<Double> preventionScores =
        getRawScores(List.of(EXPECTATION_TYPE.PREVENTION), expectations);
  ...
  public static List<Double> getRawScores(
      final List<EXPECTATION_TYPE> types, final List<RawInjectExpectation> expectations) {
    return expectations.stream()
