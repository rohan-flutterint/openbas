...
public class ResultUtils {
  ...
  public static List<ExpectationResultsByType> computeGlobalExpectationResults(
    ...
    List<InjectExpectation> expectations =
        injects.stream()
            ...
            .filter(
                expectation ->
                    expectation.getUser() == null) // Filter expectations linked to players
            .toList();
  ...
  public static List<InjectTargetWithResult> computeTargetResults(
      @NotNull final List<Inject> injects) {
